            ...
            <section className="carbon-page max-w-container">
                <div className="heading max-w column align-center">
                    ...
                    <div>
                        ...
                        <p>We also work with Inception Motorsports repairing the body of a Ferrari 296 GT3.</p>
                    </div>
                </div>
                <ImageGrid folderPath="carbon" amount={79} extension="webp" imageWidth={1500} imageHeight={1125} />
            </section>
        </>
    );
}
